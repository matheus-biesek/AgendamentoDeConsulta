...
public class TesteProducer {
    ...
    public TesteProducer() throws IOException, TimeoutException {
    ...
    public String call(String role) throws IOException, InterruptedException {
        ...
        channel.basicPublish("", QUEUE_NAME, props, role.getBytes(StandardCharsets.UTF_8));
